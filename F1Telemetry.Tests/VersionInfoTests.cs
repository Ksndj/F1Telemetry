...
public sealed class VersionInfoTests
{
    ...
    {
        Assert.Equal("1.1.1-beta1", VersionInfo.CurrentVersion);
    }
    ...
    {
        Assert.Equal("v1.1.1-beta1", VersionInfo.DisplayVersion);
    }
    ...
    public void DashboardViewModel_AppTitleText_ContainsCurrentReleaseVersion()
    {
        ...
        Assert.Contains("1.1.1-beta1", viewModel.AppTitleText, StringComparison.Ordinal);
