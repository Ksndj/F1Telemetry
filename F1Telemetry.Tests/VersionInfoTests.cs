...
public sealed class VersionInfoTests
{
    ...
    {
        Assert.Equal("1.0.2-beta2", VersionInfo.CurrentVersion);
    }
    ...
    {
        Assert.Equal("v1.0.2-beta2", VersionInfo.DisplayVersion);
    }
    ...
    public void DashboardViewModel_AppTitleText_ContainsCurrentReleaseVersion()
    {
        ...
        Assert.Contains("1.0.2-beta2", viewModel.AppTitleText, StringComparison.Ordinal);
