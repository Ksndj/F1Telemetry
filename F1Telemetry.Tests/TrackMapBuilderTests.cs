...
public sealed class TrackMapBuilderTests
{
    ...
    public void CornerAnalysisView_UsesResponsiveContainersForSummaryFiltersAndDetails()
    {
        ...
        Assert.Contains("Storyboard.TargetName=\"CornerAnalysisListColumn\"", xaml, StringComparison.Ordinal);
        Assert.Contains("Storyboard.TargetName=\"CornerAnalysisDetailsColumn\"", xaml, StringComparison.Ordinal);
