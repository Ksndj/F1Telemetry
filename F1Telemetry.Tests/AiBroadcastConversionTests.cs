...
public sealed class AiBroadcastConversionTests
{
    ...
    public void ChartsView_DefinesAiPostRaceAnalysisWorkspace()
    {
        ...
        Assert.Contains("Style=\"{StaticResource PrimaryActionButtonStyle}\"", xaml, StringComparison.Ordinal);
        Assert.Contains("Style=\"{StaticResource SecondaryActionButtonStyle}\"", xaml, StringComparison.Ordinal);
        Assert.Contains("x:Key=\"ActionButtonBaseStyle\"", xaml, StringComparison.Ordinal);
