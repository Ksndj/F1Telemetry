...
当前开发进度：`2.0.0-beta3`，V2 比赛工程台基础功能已完成，第三版 beta 聚焦最大化布局、历史分页/删除入口和复盘/对比页面滚动边界修正。
...
当前 F1Telemetry 已完成 V1 主链路，并在 `2.0.0-beta3` 进入 V2 比赛工程台 beta 阶段。旧版本详细规划不再展开保留，README 只记录当前仍有参考价值的边界：
...
V2-M1 到 V2-M7 已完成并进入 `2.0.0-beta3`；beta3 继续收紧窗口最大化布局、历史分页/删除入口和复盘/对比页面滚动边界：
